...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(4, 0, 1); // 0.36
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(6, 0, 1.2); // 6, 1.2
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap, boolean useIMU) {
...
//            RevHubOrientationOnRobot orientationOnRobot = new RevHubOrientationOnRobot(hubRotation);
            imu.initialize(new IMU.Parameters(new RevHubOrientationOnRobot(new Orientation(AxesReference.INTRINSIC,AxesOrder.ZYX,AngleUnit.DEGREES,90,240,90,0))));
        }
