...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 6.56953489 * Math.pow(10, -6);//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = -0.0086007328;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = -5.2656 * Math.pow(10, -4);//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(0, -6.375, 0);
        rightEncoderPose = new Pose(0, 5.625, 0);
        strafeEncoderPose = new Pose(-4, -0.125, Math.toRadians(90));
//        leftEncoderPose = new Pose(-6.375, 0, 0);
//        rightEncoderPose = new Pose(5.625, 0, 0);
//        strafeEncoderPose = new Pose(-0.125, -4, Math.toRadians(90));
        hardwareMap = map;
