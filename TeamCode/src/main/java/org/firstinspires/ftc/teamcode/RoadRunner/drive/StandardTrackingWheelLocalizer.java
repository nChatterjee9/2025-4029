...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 90 / 90.185; // in; distance between the left and right wheels
    public static double Y_MULTIPLIER = 90 / 90.05; // in; distance between the left and right wheels
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "intakeMotor")); // intakeMotor
